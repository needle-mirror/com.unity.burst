...
namespace Unity.Burst
{
    ...
    /// <summary>
    /// Represents the floating point optimisation mode for compilation.
    /// </summary>
    public enum FloatMode
    {
        /// <summary>Use the default target floating point mode - <see cref="FloatMode.Strict"/>.</summary>
        Default = 0,
        /// <summary>No floating point optimisations are performed.</summary>
        Strict = 1,
        /// <summary>Reserved for future.</summary>
        Deterministic = 2,
        /// <summary>
        /// Allows algebraically equivalent optimisations (which can alter the results of calculations), it implies :
        /// <para/> optimizations can assume reults and arguments contain no NaNs or +/- Infinity and treat sign of zero as insignificant.
    ...
    {
        /// <summary>Use the default target floaing point precision - <see cref="FloatPrecision.Medium"/>.</summary>
        Standard = 0,
        /// <summary>Compute with an accuracy of 1 ULP - highly accurate, but increased runtime as a result, should not be required for most purposes.</summary>
        High = 1,
        /// <summary>Compute with an accuracy of 3.5 ULP - considered acceptable accuracy for most tasks.</summary>
        Medium = 2,
        /// <summary>Reserved for future.</summary>
        Low = 3,
    }
    ...
    {
        /// <summary>
        /// Respresents the float mode of operation for this burst compilation.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Represents the floating point precision to use for this burst compilation.
        ...
        /// <summary>
        /// Represents whether or not to burst compile the code immediately on first use, or in the background over time.
        /// </summary>
